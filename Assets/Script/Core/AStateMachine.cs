...
public class AStateMachine<StateType,EventType> 
	...
	public float TimeFromStateStart {
		get { return m_timerInState; }
	}
	private float m_timerInState = 0;
	...
	public delegate void OnEventHandler( object arg );
	private Dictionary<StateType,OnEventHandler> onEventState = new Dictionary<StateType, OnEventHandler>();
	...
	{
		if ( onEventState.ContainsKey( m_state ))
		{
			onEventState [m_state] (arg);
		}
	}
}