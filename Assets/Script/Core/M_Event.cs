...
public class ButtonArg  :LogicArg 
{
	public ButtonType buttonType;
	public UIButton button;

	public ButtonArg ( object _this, ButtonType _type , UIButton _btn ) : base(_this)
	{
		buttonType = _type;
		button = _btn;
	}
...
public class EnergyBurstArg  :LogicArg 
{
	public EnergyType energyType;
	public float value;
	public EnergyBurstArg ( object _this, EnergyType _type , float _value ) : base(_this)
	{
		energyType = _type;
		value = _value;
	}
...
public class CreateFeedbackArg : LogicArg
{
	public CreatureType creatureType;
	public float value;
	public CreateFeedbackArg ( object _this , CreatureType _type , float _value ) : base(_this)
	{
		creatureType = _type;
		value = _value;
	}
...
public class FeedFeedbackArg : LogicArg {
	public EnergyType energyType;
	public FoodType foodType;
	public float value;

	public FeedFeedbackArg ( object _this , EnergyType _eType , FoodType _fType , float _value ) : base ( _this )
	{
		energyType = _eType;
		foodType = _fType;
		value = _value;
...
public class AnimalActionArg  :LogicArg 
{
	public AnimalAction animalAction;
...
public class CreateArg : LogicArg 
{
	public GameObject obj;

	public CreateArg ( object _this, GameObject _obj ) : base(_this)
	{
		obj = _obj;
	}
}

public class FoodReadyArg : LogicArg 
{
	public MFood food;
